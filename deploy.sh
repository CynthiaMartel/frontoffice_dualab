#!/bin/bash
# =============================================================================
# deploy.sh — Script de despliegue a Hostinger para info.dualab.es
# =============================================================================
# Uso:
...
SSH_KEY=/Users/cynthia/.ssh/id_rsa
SSH_PORT=65002
SSH_USER=u197312986
SSH_HOST=145.79.20.29
REMOTE_ROOT=/home/u197312986/domains/dualab.es/public_html/info
...
step_backend() {
    ...
    # bootstrap/app.php tiene el registro de middlewares (alias 'admin', etc.)
    # Se sube solo este archivo, no bootstrap/cache/ que contiene paquetes dev
    scp -P $SSH_PORT -i $SSH_KEY \
        "$BACKEND_DIR/bootstrap/app.php" \
        $SSH_USER@$SSH_HOST:$REMOTE_BACKEND/bootstrap/app.php \
        || error "Falló la subida de bootstrap/app.php"
